...
public class TravelAssistanceSteps extends BaseTest{
    ...
    public void setCountry() throws Exception{
        new GeneralPage(driver).country(data.get("Država ugovaranja"));
    }

    @And("set Place")
    public void setPlace() throws Exception{
        new GeneralPage(driver).place(data.get("Mesto ugovaranja"));
    }
    ...
    public void clickOnTabPersons() throws Exception{
        ...
        new TabViewPage(driver).assertStatus(softAssert, data.get("PocetniStatus"));
    }
   ...
   // }else
    ...
    public void clickOnButtonPrintPUI() throws Exception{
        new TopButtonViewPage(driver).clickPrintPUI();
    ...
    public void clickOnButtonConfirmPayment() throws Exception{
        new TopButtonViewPage(driver).clickConfirmPayment();
        //Thread.sleep(5000);
    }
    ...
    public void clickOnButtonCertificationOfSignature()throws Exception {
        ...
        new TopButtonViewPage(driver).print(data.get("Stampa"));
        //Thread.sleep(5000);
    }
