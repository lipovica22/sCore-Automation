...
public class LoginSteps extends BaseTest {
    ...
    public void enterUsername(String username) throws Exception {
        new cSore_Mapping.Common.Pages.LoginPage(driver).setUsername(username);
    }

    @And("enter password {string}")
    public void enterPassword(String password) throws Exception {
        new cSore_Mapping.Common.Pages.LoginPage(driver).setPassword(password);
    }

    @And("click on Submit button")
    public void clickOnSubmitButton() throws Exception {
        new cSore_Mapping.Common.Pages.LoginPage(driver).clickSubmit();
    }

    @Then("Logged in {string}")
    public void loggedIn(String loggedUser) throws Exception {
        Assert.assertEquals(new cSore_Mapping.Common.Pages.LoginPage(driver).LoggedUser(),loggedUser);
    }
